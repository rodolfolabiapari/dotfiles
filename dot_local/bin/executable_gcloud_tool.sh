...
show_menu() {
    ...
    echo "4) Definir Projeto ID no perfil atual"
    echo "5) Definir Conta (E-mail) no perfil atual"
    echo "6) Excluir um perfil"
    echo "7) Ver detalhes da config atual"
    echo "8) Realizar auth application-default login nesse contexto atual"
    echo "9) Sair"
    echo "==================================="
...
auth_login() {
    echo "--- Iniciando Auth no Perfil Atual ---"
