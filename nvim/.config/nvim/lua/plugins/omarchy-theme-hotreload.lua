-- Omarchy theme hot-reload: escuta o evento LazyReload e troca o tema em
-- tempo real, limpando highlights e recarregando o symlink de theme.lua.
-- Permite trocar de tema pelo sistema Omarchy sem reiniciar o Neovim.
