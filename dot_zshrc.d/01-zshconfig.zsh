...
#ZSH_THEME="powerlevel10k/powerlevel10k" load manualy at bottom this file
#ZSH_THEME="robbyrussell"

# Set list of themes to pick from when loading at random
# Setting this variable when ZSH_THEME=powerlevel10k/powerlevel10k
#ZSH_THEME=random will cause zsh to load
...
plugins=(git ssh-agent kubectl web-search)
...
# Habilita modo vi no zsh
bindkey -v
export KEYTIMEOUT=1
# Volta o ctrl-r na busca historica
bindkey ^R history-incremental-search-backward
bindkey ^S history-incremental-search-forward
# edit line inv vim buffer ctrl-v
autoload edit-command-line; zle -N eit-command-line
