# Generated by Powerlevel10k configuration wizard on 2020-11-17 at 21:07 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_GCLOUD_PARTIAL_CONTENT_EXPANSION='${P9K_GCLOUD_PROJECT_ID//\%/%%} ${P9K_GCLOUD_CONFIGURATION}'
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_PROJECT_NAME//\%/%%} ${P9K_GCLOUD_CONFIGURATION}'
