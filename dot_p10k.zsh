# Generated by Powerlevel10k configuration wizard on 2024-09-04 at 17:46 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_CONTENT_EXPANSION='${P9K_AWS_PROFILE//\%/%%}${P9K_AWS_REGION:+ ${P9K_AWS_REGION//\%/%%}} $(vault_remain)'
